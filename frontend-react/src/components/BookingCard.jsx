      ...
      <div className="card">
        <div className="flex items-center gap-3 mb-2">
          <div className="p-2 bg-spacemacs-light-blue/10 dark:bg-spacemacs-dark-blue/10 rounded-lg">
            <svg className="w-6 h-6 text-spacemacs-light-blue dark:text-spacemacs-dark-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div className="card">
      ...
      <div className="grid grid-cols-3 gap-4 mb-4">
        <div className="text-center">
          <div className="text-2xl font-bold text-spacemacs-light-green dark:text-spacemacs-dark-green">
            {metadata.successful_bookings || 0}
          </div>
          <div className="text-xs text-gray-600 dark:text-gray-400">Confirmed</div>
        </div>
        <div className="text-center">
          <div className="text-2xl font-bold text-spacemacs-light-yellow dark:text-spacemacs-dark-yellow">
            {bookingList.filter(b => b.status === 'pending').length}
          </div>
          <div className="text-xs text-gray-600 dark:text-gray-400">Pending</div>
        </div>
        <div className="text-center">
          <div className="text-2xl font-bold text-spacemacs-light-red dark:text-spacemacs-dark-red">
      ...
      {expanded && recentBookings.length > 0 && (
        <div className="pt-4 border-t space-y-2">
          ...
          {recentBookings.map((booking) => (
            <div
              key={booking.id}
              className="p-3 rounded-md bg-gray-50 dark:bg-gray-800/50 space-y-1"
            >
              ...
              {booking.error && (
                <div className="text-xs text-spacemacs-light-red dark:text-spacemacs-dark-red mt-1">
                  Error: {booking.error}
                </div>
              )}
            </div>
